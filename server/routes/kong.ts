...
export function registerKongRoutes(app: Express, storage: IStorage): void {
  ...
  app.get("/api/kong/service-catalog", async (_req, res) => {
    ...
    const catalog = [
      ...
      { name: "plenumnet-calendars", label: "Calendar Synchronization", routePath: "/api/salvi/timing/epoch", endpointCount: 44, category: "core", endpoints: ["GET /anchors", "GET /calendars", "GET /calendars/mayan", "GET /calendars/hebrew", "GET /calendars/chinese", "GET /calendars/vedic", "GET /calendars/egyptian", "GET /calendars/julian-day", "GET /calendars/islamic", "GET /calendars/byzantine", "GET /calendars/thirteen-moon", "GET /calendars/persian", "GET /calendars/ethiopian", "GET /calendars/coptic", "GET /calendars/japanese", "GET /calendars/korean", "GET /calendars/thai", "GET /calendars/indian-saka", "GET /calendars/tibetan", "GET /calendars/aztec", "GET /calendars/roman", "GET /calendars/bengali", "GET /calendars/berber", "GET /calendars/balinese", "GET /calendars/zoroastrian", "GET /calendars/aboriginal", "GET /calendars/assyrian", "GET /calendars/nisgaa", "GET /calendars/yoruba", "GET /calendars/jain", "GET /calendars/tamil", "GET /calendars/vietnamese", "GET /calendars/vikram-samvat", "GET /calendars/khmer", "GET /calendars/burmese", "GET /calendars/javanese", "GET /calendars/malayalam", "GET /calendars/nepal-sambat", "GET /calendars/nanakshahi", "GET /calendars/bahai", "GET /calendars/minguo", "GET /calendars/igbo", "GET /calendars/akan", "GET /calendars/gregorian"] },
      ...
      { name: "plenumnet-phase", label: "Phase Encryption", routePath: "/api/salvi/phase", endpointCount: 6, category: "core", endpoints: ["GET /config/:mode", "POST /split", "POST /recombine", "GET /recommend", "POST /batch/split", "POST /batch/recombine"] },
