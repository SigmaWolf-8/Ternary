...
**Version 1.0 — Effective February 11, 2026**
...
**"You"** (or **"Your"**) means the copyright owner or legal entity authorized by the copyright owner that is making this Agreement with the Company. For legal entities, the entity making a Contribution and all other entities that control, are controlled by, or are under common control with that entity are considered to be a single Contributor.

**"Contribution"** means any work of authorship, including any original work, modification, or addition to an existing work, that is intentionally submitted by You to the Company for inclusion in or documentation of the Project. For purposes of this definition, "submitted" means any form of electronic, verbal, or written communication sent to the Company or its representatives, including but not limited to communication on electronic mailing lists, source code control systems, and issue tracking systems that are managed by or on behalf of the Company for the purpose of discussing and improving the Project. Communication that is conspicuously marked or otherwise designated in writing by You as "Not a Contribution" shall be excluded.

**"Project"** means the Salvi Framework, PlenumNET platform, and all associated repositories, documentation, and materials maintained by the Company, including but not limited to the repository at https://github.com/SigmaWolf-8/Ternary.
...
(c) **You understand the mathematical and theoretical requirements.** You acknowledge that the Project operates under rigorous mathematical standards derived from the Unified 13D Torsion Plenum Theory and GF(3) arithmetic, and that Your Contributions must conform to these standards as described in the CONTRIBUTING.md document.
