          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>42 calendar synchronization endpoints via JDN intermediary</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  {[
                    { method: "GET", path: "/api/salvi/timing/epoch/anchors", desc: "All epoch anchor points" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars", desc: "All 42 calendar conversions" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/aboriginal", desc: "Aboriginal Seasonal (~65,000 yr)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/thirteen-moon", desc: "13-Moon Harmonic (~30,000 yr)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/byzantine", desc: "Byzantine (5509 BCE)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/assyrian", desc: "Assyrian (4750 BCE)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/julian-day", desc: "Julian Day Number (4713 BCE)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/nisgaa", desc: "Nisg\u0331a\u2019a Seasonal (oral)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/hebrew", desc: "Hebrew Anno Mundi (3761 BCE)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/mayan", desc: "Mayan Long Count (3114 BCE)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/aztec", desc: "Aztec Tonalpohualli (260-day)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/kali-yuga", desc: "Vedic Kali Yuga (3102 BCE)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/igbo", desc: "Igbo (4-day week + 13 months)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/yoruba", desc: "Yoruba (4-day Oj\u00F3 week)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/akan", desc: "Akan (42-day Adae cycle)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/egyptian", desc: "Egyptian Civil (Sothic cycle)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/chinese", desc: "Chinese Sexagenary (60-year)" },
                    ...
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/japanese", desc: "Japanese Imperial K\u014Dki" },
                    ...
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/hijri", desc: "Islamic Hijri (lunar)" },
                    ...
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/gregorian", desc: "Gregorian (civil standard)" },
                    { method: "GET", path: "/api/salvi/timing/epoch/calendars/bahai", desc: "Bah\u00E1\u2019\u00ED Bad\u00ED\u2019 (19\u00D719)" },
