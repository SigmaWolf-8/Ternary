  ...
  return (
    <section id="hero" className="relative pt-6 pb-12 md:pt-8 md:pb-16 overflow-hidden" data-testid="section-hero" role="region" aria-labelledby="hero-title">
      <div className="relative z-10 max-w-7xl mx-auto px-5">
        ...
        <h1 
          className="text-3xl md:text-4xl lg:text-[2.8rem] font-bold leading-[1.1] mb-6 text-center"
        ...
        >
          <img src={plenumLogoHero} alt="PlenumNET" className="inline-block h-[3em] align-middle mt-1 mr-2" style={{ objectFit: "contain", objectPosition: "center" }} /> ~ A Geometrically Derived<br />Self Healing Computing Universe
        </h1>
