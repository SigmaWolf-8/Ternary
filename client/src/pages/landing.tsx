  ...
  return (
    <section id="hero" className="relative pt-6 pb-12 md:pt-8 md:pb-16 overflow-hidden" data-testid="section-hero" role="region" aria-labelledby="hero-title">
      <div className="relative z-10 max-w-7xl mx-auto px-5">
        ...
        >
          <div><img src={plenumLogoHero} alt="PlenumNET" className="inline-block h-[3em] align-middle mt-1 mr-4" style={{ objectFit: "contain", objectPosition: "center", position: "relative", left: "20px" }} /> ~ A Geometrically Derived</div>
          <div className="-mt-3 relative z-10" style={{ position: "relative", top: "-4px" }}>Self Healing Computing Universe</div>
        </h1>
              ...
              <div className="max-w-3xl mx-auto text-left space-y-8">
                ...
                <div>
                  <div className="flex items-baseline gap-2">
                    <span className="text-lg font-medium tracking-wide uppercase text-muted-foreground">The Foundation</span>
                ...
                <div>
                  <div className="flex items-baseline gap-2">
                    <span className="text-lg font-medium tracking-wide uppercase text-muted-foreground">The Architecture</span>
                    <span className="text-muted-foreground/50">~</span>
                ...
                <div>
                  <div className="flex items-baseline gap-2">
                    <span className="text-lg font-medium tracking-wide uppercase text-muted-foreground">The Opportunity</span>
                    <span className="text-muted-foreground/50">~</span>
