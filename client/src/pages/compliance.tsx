...
const timeline: TimelineMilestone[] = [
  ...
  },
  {
    ...
    description: "Formal FIPS validation process initiated for AES-256-GCM, TL-KEM, and TL-DSA implementations. Side-channel analysis and constant-time verification.",
    algorithms: [],
    status: "planned",
  },
  {
    year: 2028,
    title: "Binary Interoperability",
    description: "Full binary compatibility layer for seamless interop with standard ML-KEM and ML-DSA implementations. Hybrid mode for transition deployments.",
    algorithms: [],
    status: "planned",
  },
  {
