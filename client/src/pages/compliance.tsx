...
const cnsa2Matrix: ComplianceMapping[] = [
  ...
  },
  {
    ...
    deadline: "Immediate",
    status: "equivalent",
    plenumEquivalent: "TL-Sponge (243-trit)",
  ...
  },
  {
    ...
    deadline: "Immediate",
    status: "equivalent",
    plenumEquivalent: "TL-Sponge (486-trit extended)",
  ...
  },
  {
    ...
    securityNotes: "Complete SP 800-208 implementation. LM-OTS Winternitz one-time signatures (W=1/2/4/8) with Merkle tree authentication (heights 5/10/15/20/25). Stateful signing with monotonic index tracking and StateExhausted enforcement. TL-Sponge hash with domain separation.",
  },
  {
    algorithm: "XMSS",
    nistStandard: "SP 800-208",
...
const timeline: TimelineMilestone[] = [
  {
    ...
    description: "TL-Sponge hash, HMAC, KDF, and Lamport OTS provide GF(3)-native equivalents for SHA-384/512 and LMS/XMSS. Phase encryption provides symmetric encryption.",
