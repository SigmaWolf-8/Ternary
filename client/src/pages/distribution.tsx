...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    version: "v1.0",
    desc: "Construction proven secure by wide-trail analysis (DP \u2264 9\u207B\u2074\u2070\u2079\u2076). Parameters sized for fast integrity (43-bit capacity), not cryptographic resistance. 303 ns, SSE2 SIMD.",
    category: "crypto",
    size: "9 KB",
    format: ".rs / .ts",
