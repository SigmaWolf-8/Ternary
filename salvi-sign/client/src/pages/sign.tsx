...
export default function Sign() {
  ...
  const signMutation = useMutation({
    mutationFn: async (data: { fieldValues: Record<string, string> }) => {
      await apiRequest("POST", `/api/envelopes/${envelopeId}/sign`, {
        recipientId,
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto p-5 flex justify-center">
        <div
            ...
            return (
              ...
              >
                {hasValue ? (
                  ...
                  <span className="text-[9px] font-medium text-primary capitalize select-none tracking-wide">
                    {f.type === "signature" ? "Click to sign" : f.type === "checkbox" ? "" : `Enter ${f.type}`}
                  </span>
                )}
              </div>
            );
