...
By accessing or using the PlenumNET platform, including any associated applications, APIs, services, or websites (collectively, the "Service"), you ("User," "You," or "Your") agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you must not access or use the Service.

If you are using the Service on behalf of a legal entity, you represent and warrant that you have the authority to bind that entity to these Terms, and "You" refers to that entity.

---

## 2. Description of Service

PlenumNET is a post-quantum ternary computing platform providing, among other capabilities:

- Ternary arithmetic operations (GF(3) field operations)
- Post-quantum cryptographic services (CNSA 2.0 compliant)
- High-Precision Timing Protocol (HPTP) services
- Phase encryption and decryption services
- Calendar system conversions
- Data compression and storage services
...
4.1 **Account Registration.** Certain features of the Service may require account registration. You agree to provide accurate, current, and complete information during registration and to keep your account information updated.

4.2 **Account Security.** You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. You agree to notify us immediately of any unauthorized use.

4.3 **API Keys.** If you are issued API keys or access tokens, you shall treat them as confidential and shall not share, publish, or embed them in publicly accessible code or applications.

---

## 5. Permitted Use

5.1 **License Grant.** Subject to these Terms, We grant You a limited, non-exclusive, non-transferable, revocable license to access and use the Service for your lawful internal purposes.
...
(c) Copy, modify, distribute, sell, lease, or sublicense the Service or any output thereof;

(d) Use the Service to develop any product or service that competes with the Service;

(e) Exceed any rate limits, usage quotas, or access restrictions imposed by the Company;

(f) Interfere with or disrupt the integrity or performance of the Service;

(g) Attempt to gain unauthorized access to the Service, related systems, or networks;
...
7.4 **No Data Guarantees.** The Service is provided for computational and informational purposes. We do not guarantee the accuracy, completeness, or fitness for purpose of any output, computation, or result produced by the Service.

---

## 8. Service Availability and Modifications

8.1 **Availability.** We will use commercially reasonable efforts to maintain the Service, but We do not guarantee uninterrupted or error-free operation.

8.2 **Modifications.** We reserve the right to modify, suspend, or discontinue the Service (or any part thereof) at any time, with or without notice. We shall not be liable to You or any third party for any such modification, suspension, or discontinuation.

8.3 **Updates to Terms.** We may update these Terms from time to time. Continued use of the Service after such changes constitutes acceptance of the modified Terms.
...
THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, NON-INFRINGEMENT, ACCURACY, RELIABILITY, SECURITY, OR COMPLETENESS.

THE COMPANY DOES NOT WARRANT THAT: (A) THE SERVICE WILL MEET YOUR REQUIREMENTS; (B) THE SERVICE WILL BE UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE; (C) THE RESULTS OBTAINED FROM THE SERVICE WILL BE ACCURATE OR RELIABLE; (D) ANY CRYPTOGRAPHIC OPERATIONS PERFORMED BY THE SERVICE WILL PROVIDE ABSOLUTE SECURITY AGAINST ANY OR ALL ATTACK VECTORS, INCLUDING QUANTUM COMPUTING ATTACKS.
...
13.1 **By You.** You may terminate your use of the Service at any time by discontinuing access and, if applicable, closing your account.

13.2 **By Us.** We may terminate or suspend Your access to the Service immediately, without prior notice or liability, for any reason, including if You breach these Terms.

13.3 **Effect of Termination.** Upon termination, Your right to use the Service ceases immediately. Provisions that by their nature should survive termination shall survive, including but not limited to Sections 6, 10, 11, 12, and 14.
...
14.4 **Waiver.** No waiver of any provision of these Terms shall be deemed a further or continuing waiver of such provision or any other provision.

14.5 **Entire Agreement.** These Terms, together with the Privacy Policy and Acceptable Use Policy, constitute the entire agreement between You and the Company regarding the Service.
