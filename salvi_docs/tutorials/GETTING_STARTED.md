...
Welcome to the Salvi Framework - a complete post-quantum ternary computing stack. This tutorial will get you from zero to running ternary code in under 15 minutes.
...
fn main() {
    ...
    let inv = b.inverse();
    println!("Inverse of 2 in GF(3) = {}", inv);  // Output: 2 (since 2*2=4=1 mod 3)
}
```
...
The Ternary Virtual Machine (TVM) executes ternary bytecode with a 160-opcode ISA v2.0:
...
fn main() {
    ...
    println!("Binary {} -> Ternary {:?}", binary_value, ternary);
    ...
    println!("Float conversion: {} -> {:?} -> {}", float_val, ternary_float, back_float);
...
| Topic | Guide |
|-------|-------|
| Memory Management | [Kernel Memory Guide](../modules/01_KERNEL_MEMORY.md) |
| Synchronization | [Sync Primitives Guide](../modules/02_SYNC_PRIMITIVES.md) |
| Post-Quantum Crypto | [Cryptography Guide](../modules/05_CRYPTOGRAPHY.md) |
| Network Topology | [Torsion Network Guide](../modules/09_TORSION_NETWORK.md) |
| Virtual Machine | [TVM Guide](../modules/11_TVM.md) |
| Binary Interop | [BTG Guide](../modules/13_BTG.md) |
...
- **Source Code:** The best documentation is often the code itself - explore `src/`

---

*Welcome to the future of post-quantum computing. Cosi sia.*
