...
**File:** `formal/xplenum_rvfi_insn_gen.py`  
**Output:** `formal/generated/rvfi_insn_*.sv` (21 modules + wrapper)
...
**File:** `formal/xplenum_pipeline_props.sv`
...
**File:** `formal/xplenum_no_harm.sv`
...
**File:** `formal/xplenum_formal.sby`
...
**File:** `rtl/xplenum_dom_gadgets.v`
...
**File:** `tb/xplenum_fault_inject_tb.v`
...
**File:** `rtl/xplenum_tamper_response.v`
...
**Output:** `docs/xplenum/phase8_sfr_mapping.json`
...
|------|-------|-------------|
| `formal/xplenum_rvfi_insn_gen.py` | ~380 | RVFI property generator (21 instructions) |
| `formal/generated/rvfi_insn_*.sv` | 21 files | Generated instruction property modules |
| `formal/generated/xplenum_rvfi_props.sv` | ~100 | Top-level RVFI property wrapper |
| `formal/xplenum_pipeline_props.sv` | ~280 | Pipeline SVA properties (P100–P600) |
| `formal/xplenum_no_harm.sv` | ~120 | No-harm proofs (NH-1 to NH-4) |
| `formal/xplenum_formal.sby` | ~70 | SymbiYosys configuration |

### Track 8B: Higher-Order Masking
| File | Lines | Description |
|------|-------|-------------|
| `rtl/xplenum_dom_gadgets.v` | ~340 | DOM AND/XOR/Refresh gadgets (3-share, 4-share) |
...
| File | Lines | Description |
|------|-------|-------------|
| `rtl/xplenum_pqc_unit.v` | ~240 | PQC hardware unit (10 instructions) |
| `src/kernel/xplenum/pqc.rs` | ~280 | Rust API for ML-KEM/ML-DSA |

### Track 8D: Adversarial Validation
| File | Lines | Description |
|------|-------|-------------|
| `tb/xplenum_fault_inject_tb.v` | ~230 | Fault injection testbench |
| `rtl/xplenum_tamper_response.v` | ~160 | Tamper response module |

### Track 8E: Common Criteria
| File | Lines | Description |
|------|-------|-------------|
| `scripts/cc_sfr_mapper.py` | ~280 | SFR mapping tool |
| `docs/xplenum/phase8_sfr_mapping.json` | ~200 | Generated SFR mapping report |
...
**File:** `rtl/integration/xplenum_cva6_wrapper_v2.v`
...
**File:** `rtl/xplenum_pkg.vh` (v2.0.0)
