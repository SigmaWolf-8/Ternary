...
├─────────────────────────────────────────────────────────────┤
│  User Space (Mode φ)  │  Kernel Space (Mode 0/1)            │
├───────────────────────┴─────────────────────────────────────┤
│                      Page Tables                             │
│    ┌─────────┐    ┌─────────┐    ┌─────────┐               │
...
- [Process Management](./03_PROCESS_MANAGEMENT.md) — Address space per process
- [Modal Security](./04_MODAL_SECURITY.md) — Protection enforcement
- [Device Drivers](./07_DEVICE_DRIVERS.md) — DMA buffer allocation
