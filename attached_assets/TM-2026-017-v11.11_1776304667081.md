...
Measured (CODATA 2018): 137.035999. Match: 0.007 ppm. All framework constants. The cone-point correction (pqr → pqr−1) from TM-2026-031 §4.3 improves the match by 37×.
...
|--------|-----------|-------|
| 1/α | R₂² + q² + (p−r)²/(pqr−1) = 137 + 36/1000 | 0.007 ppm |
| κ | 1 + 26,147,000 / 137,036² | **0.13 ppb** |
...
Measured (CODATA 2018): 1/α = 137.035999. **Match: 0.007 ppm.** Every term is a framework constant.
...
> **1/α = 137,036 / 1,000 = 137.036000 exactly**

CODATA 2022 measures 137.035999177 ± 0.000000021 — lying **6.0 ppb below** the framework value (narrowed from 6.7 ppb in CODATA 2018). This is a falsifiable prediction: future measurements will either shift toward 137.036000 or exclude this value. The prediction is not fitted — it is forced by Fermat's two-square theorem (137 = 4² + 11²), the asymmetry (p−r)² = 36, and the cone-point corrected walk pqr − 1 = 1000.

**From α to κ.** The multiplier D connects α to the bridge coefficient. The cone-point correction (pqr → pqr−1) that corrected 1/α also corrects D:
...
|-----------------|-----------|-----------|
| Fine structure constant | (p−r)²/(pqr−1) numerator pair | 6.0 ppb |
| Bridge coefficient κ | D = x₂ + 147/1000 | 0.13 ppb |
