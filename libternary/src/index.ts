/**
 * libternary - Salvi Framework Core Library
 * 
 * A TypeScript/JavaScript library implementing the Unified Ternary Logic System
 * from the Salvi Framework whitepaper for post-quantum cryptographic applications.
 * 
 * Features:
