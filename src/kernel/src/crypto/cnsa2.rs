...
pub fn get_cnsa2_matrix() -> Vec<Cnsa2Mapping> {
    vec![
        ...
        Cnsa2Mapping {
            ...
            status: ComplianceStatus::TernaryEquivalent,
            plenum_equivalent: String::from("TL-Sponge-385 (243-trit output)"),
        ...
        Cnsa2Mapping {
            ...
            status: ComplianceStatus::TernaryEquivalent,
            plenum_equivalent: String::from("TL-Sponge-385 (extended 486-trit output)"),
        ...
        Cnsa2Mapping {
            ...
            security_notes: String::from(
                "Full Leighton-Micali Signature scheme with LM-OTS one-time \
                 ...
                 reuse. TL-Sponge-385 as underlying hash function. \
    ...
    vec![
        TransitionMilestone {
            ...
            description: String::from(
                "TL-Sponge-385, HMAC, KDF, Lamport OTS, full XMSS with \
        ...
        TransitionMilestone {
            ...
            description: String::from(
                "Stateful hash-based signature trees using TL-Sponge-385. \
