...
export const SERVICE_CATALOG: ServiceDef[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "POST", path: "/api/salvi/crypto/hash", desc: "TL-Sponge-385 document hash (385-bit PQ)" },
      { method: "GET", path: "/api/salvi/crypto/phase-benchmark", desc: "Phase encryption benchmark suite", tryIt: true },
    ],
  },
  {
    id: "tl-dsa",
    name: "TL-DSA Signatures",
    description: "Ternary Lattice Digital Signature Algorithm — WOTS+ over GF(3) sponge, CNSA 2.0 aligned (EUF-CMA)",
    icon: "Shield",
    color: "text-violet-600",
    kong: {
      serviceName: "plenumnet-tl-dsa",
      routePath: "/api/salvi/crypto/tl-dsa",
      tags: ["plenumnet", "tl-dsa", "pqc", "signatures", "cnsa"],
      rateLimit: { minute: 60, hour: 600 },
      methods: ["GET", "POST"],
    },
    endpoints: [
      { method: "GET", path: "/api/salvi/crypto/tl-dsa/spec", desc: "TL-DSA algorithm specification and variant details", tryIt: true },
      { method: "POST", path: "/api/salvi/crypto/tl-dsa/keygen", desc: "Generate TL-DSA keypair (29/58/87-bit variants)" },
      { method: "POST", path: "/api/salvi/crypto/tl-dsa/sign", desc: "Sign message with ephemeral TL-DSA key" },
      { method: "POST", path: "/api/salvi/crypto/tl-dsa/verify", desc: "Verify TL-DSA signature (public key only)" },
    ],
  },
  {
    id: "pt26",
    name: "PT-26 Hypercube Signatures",
    description: "PT26-DSA — post-quantum signatures via deterministic walks on the 13D ternary hypercube, committed through TL-Sponge-385",
    icon: "Hexagon",
    color: "text-fuchsia-600",
    kong: {
      serviceName: "plenumnet-pt26",
      routePath: "/api/salvi/crypto/pt26",
      tags: ["plenumnet", "pt26", "pqc", "hypercube", "signatures"],
      rateLimit: { minute: 60, hour: 600 },
      methods: ["GET", "POST"],
    },
    endpoints: [
      { method: "GET", path: "/api/salvi/crypto/pt26/spec", desc: "PT-26 algorithm specification and benchmarks", tryIt: true },
      { method: "POST", path: "/api/salvi/crypto/pt26/keygen", desc: "Generate PT-26 keypair on a 13D cube address" },
      { method: "POST", path: "/api/salvi/crypto/pt26/sign", desc: "Sign message via hypercube walk" },
      { method: "POST", path: "/api/salvi/crypto/pt26/verify", desc: "Verify PT-26 signature (public key only)" },
    ],
  },
  {
    id: "tl-kem",
    name: "TL-KEM Key Encapsulation",
    description: "Ternary Lattice KEM — IND-CCA2 key exchange over GF(3) polynomial rings, CNSA 2.0 aligned",
    icon: "Key",
    color: "text-amber-700",
    kong: {
      serviceName: "plenumnet-tl-kem",
      routePath: "/api/salvi/crypto/tl-kem",
      tags: ["plenumnet", "tl-kem", "pqc", "key-exchange", "cnsa"],
      rateLimit: { minute: 60, hour: 600 },
      methods: ["GET"],
    },
    endpoints: [
      { method: "GET", path: "/api/salvi/crypto/tl-kem/spec", desc: "TL-KEM algorithm specification (512/768/1024 variants)", tryIt: true },
    ],
  },
  {
    id: "capabilities",
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "POST", path: "/api/compression/file/raw", desc: "Compress file (raw binary response)" },
      { method: "POST", path: "/api/compression/decompress", desc: "Decompress TTC binary" },
      { method: "POST", path: "/api/compression/decompress/raw", desc: "Decompress TTC (raw binary response)" },
...
export const DOMAIN_GROUPS: DomainGroupDef[] = [
  ...
  },
  {
    ...
    serviceIds: ["phase", "tl-dsa", "pt26", "tl-kem", "tsa", "hedera"],
  },
  {
    id: "security",
