...
The Salvi Framework `libternary` kernel must choose which representation sits at the lowest layer of the stack — the layer that the 160 VM opcodes (ISA v2.0) operate on directly.
