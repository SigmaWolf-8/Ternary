...
The Salvi Framework `libternary` kernel must choose which representation sits at the lowest layer of the stack — the layer that the 62 VM opcodes operate on directly.
