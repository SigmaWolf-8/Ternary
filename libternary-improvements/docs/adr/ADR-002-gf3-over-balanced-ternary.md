...
The Salvi Framework `libternary` kernel must choose which representation sits at the lowest layer of the stack — the layer that the 176 VM opcodes (ISA v2.1) operate on directly.
